...
import {ColorMinerSceneModel} from "./Scene/ColorMinerScene";
import {ColorMinerSceneController} from "./Scene/ColorMinerScene";
const SceneModel = new ColorMinerSceneModel();
SceneModel.confirmInitialized();
const SceneController = new ColorMinerSceneController(SceneModel);
